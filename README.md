...
five at the Google Nexus Hackathon: bank API integrations, eFaktura (eInvoice), Serbian legal database,
...
Central and Eastern Europe in the Global AI Race.*
- PSIML 11 participant.
- IOAA 2022 and a national title in astrophysics.
- National 2nd place awards in Mathematics and Physics (which is where all of this started). 
