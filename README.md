...
**[cpp-shell-interpreter]([[FILL: link](https://github.com/stefbrankovic/cpp-shell-interpreter)])** - A command-line shell built from scratch in C++:
...
**[finstat-ai]([[FILL: link](https://github.com/stefbrankovic/finstat-ai-google-nexus-hackathon)])** - SME finance platform built in 36 hours with a team of
